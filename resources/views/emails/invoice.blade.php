                                          ...
                                          <table width="100%" cellpadding="0" cellspacing="0">
                                             <tr>
                                                <td data-color="text" data-size="size navigation" data-min="10" data-max="22" data-link-style="text-decoration:none; color:#888;" class="nav" align="right" style="font:bold 13px/15px Arial, Helvetica, sans-serif; color:#888;">
                                                   <a target="_blank" style="text-decoration:none; color:#888;" href="#"></a> &nbsp; &nbsp; <a target="_blank" style="text-decoration:none; color:#888;" href="#"></a> &nbsp; &nbsp; <a target="_blank" style="text-decoration:none; color:#888;" href=base_url+"/support/complaint">Support</a>
                                                </td>
                                             </tr>
                                          </table>
                                       </th>
                                          ...
                                          <table width="134" align="center" style="margin:0 auto;" cellpadding="0" cellspacing="0">
                                             ...
                                             <tr>
                                                <td data-bgcolor="bg-button" data-size="size button" data-min="10" data-max="16" class="btn" align="center" style="font:12px/14px Arial, Helvetica, sans-serif; color:#f8f9fb; text-transform:uppercase; mso-padding-alt:12px 10px 10px; border-radius:2px;" >
                                                   <a style="text-decoration:none;  padding:12px 10px 10px;" href="#"><img src=base_url+"/asset/front_dashboard/img/facebook.png" alt="facebook" target="_blank"></a>
                                                   <a style="text-decoration:none;  padding:12px 10px 10px;" href="#"><img src=base_url+"/asset/front_dashboard/img/google-plus.png" alt="google" target="_blank"></a>
                                                   <a style="text-decoration:none;  padding:12px 10px 10px;" href="#"><img src=base_url+"/asset/front_dashboard/img/twitter.png" alt="twitter" target="_blank"></a
                                                </td>
                                             </tr>
                                          </table>
                                       </td>
