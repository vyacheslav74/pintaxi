...
<div class="content-area py-1">
    <div class="container-fluid">
    	<div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="<?php echo e(route('admin.pushnotification.store')); ?>" method="POST" enctype="multipart/form-data" role="form">
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						<input class="form-control" type="text" name="title" value="<?php echo e(old('title')); ?>" id="title" placeholder="Title">
					</div>
				</div>
                ...
                <div class="form-group row">
					...
					<div class="col-xs-10">
						<input class="form-control" type="text" name="url" value="<?php echo e(old('url')); ?>" id="url" placeholder="Url">
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						<input class="form-control" type="date" name="expiration_date" value="<?php echo e(old('expiration_date')); ?>" id="expiration_date" placeholder="Expiration Date">
					</div>
				</div>
				<div class="form-group row">
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						...
						<a href="<?php echo e(route('admin.pushnotification.index')); ?>" class="btn btn-default">Cancel</a>
					</div>
				</div>
			</form>
		</div>
...
<script>
    $(document).ready(function(){
        ...
        $('#zone').change(function(){
            ...
            if($('#zone').val()==1){
                if($("#type").val()>0){
                    var url = "<?php echo e(url('admin/pushnotification/getProvidersAndUsers')); ?>";
                    var typeid = $("#type").val();
                    $.ajax({
                        type: 'get',
                        url: url+'/'+typeid,
            ...
            if($('#zone').val()==2){
            //get zones 
                var url = "<?php echo e(url('admin/pushnotification/getZones')); ?>";
                $.ajax({
                    type: 'get',
                    url: url,
                    dataType: 'html',      //return data will be json
     ...
     function getZone(id){
        $('#users-and-providers').html('');
        if($("#type").val()>0){
                var url = "<?php echo e(url('admin/pushnotification/getZoneProviders')); ?>";
                var typeid = $("#type").val();
            if(id>0){
                $.ajax({
                    type: 'get',
