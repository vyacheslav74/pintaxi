...
<?php echo $__env->make('admin.layout.partials.zone_form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('scripts'); ?>
<script async defer src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(env('GOOGLE_MAP_KEY')); ?>&libraries=geometry,places,drawing&callback=initialize&ext=.js"></script>
<script type="text/javascript">
    ...
    <?php if( isset( $zone ) ) { ?>
        edit_zone =  <?php echo json_encode ( $zone ); ?>;
        if( edit_zone ) {
    ...
    function addZone(zone_id, zone_name,country_name,state_name,city_name,status_name,currency_name, path_coordinate) {
        ...
        $.ajax({
            ...
            success     :   function(json) {
                if( json.status ) {
                    window.location.replace("<?php echo e(route('admin.zone.index')); ?>"); 
                }
            }
        });
    } 
