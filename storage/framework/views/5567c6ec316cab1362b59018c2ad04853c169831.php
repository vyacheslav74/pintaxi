   ...
   <div class="container">
      ...
      <div class="row">
               ...
               <div class="side_menu" id="left_menu">
                           ...
                           <div class="row">
                              ...
                              <div class="col-md-6">
                                 ...
                                 <div class="right-navbar">
                                    ...
                                    <h3><?php echo e(trans('header.ride_name')); ?></h3>

                                    <div class="nav-bar">

                                       <ul>

                                          <li><a href="<?php echo e(url('ride_overview')); ?>"><?php echo e(trans('header.ride.overview')); ?></a></li>

                                          <li><a href="<?php echo e(url('how_it_works')); ?>"><?php echo e(trans('header.ride.how_it_work')); ?></a></li>

                                          <li><a href="<?php echo e(url('fare_estimate')); ?>"><?php echo e(trans('header.ride.fare_estimator')); ?></a></li>

                                          <li><a href="<?php echo e(url('ride_safety')); ?>"><?php echo e(trans('header.ride.safety')); ?></a></li>

                                          <li><a href="<?php echo e(url('cities')); ?>"><?php echo e(trans('header.ride.cities')); ?></a></li>

                                          <li><a href="airports"><?php echo e(trans('header.ride.airports')); ?></a></li>
                              ...
                              <div class="col-md-6">
                                 ...
                                 <div class="left-navbar">
                                    ...
                                    <h3><?php echo e(trans('header.drive_name')); ?></h3>

                                    <div class="nav-bar">

                                       <ul>

                                          <li><a href="<?php echo e(url('drive_overview')); ?>"><?php echo e(trans('header.drive.overview')); ?></a></li>

                                          <li><a href="<?php echo e(url('requirements')); ?>"><?php echo e(trans('header.drive.requirements')); ?></a></li>

                                          <li><a href="<?php echo e(url('driver_app')); ?>"><?php echo e(trans('header.drive.driver_app')); ?></a></li>

                                          <li><a href="<?php echo e(url('vehicle_solutions')); ?>"><?php echo e(trans('header.drive.vehicle_solutions')); ?></a></li>

                                          <li><a href="<?php echo e(url('drive_safety')); ?>"><?php echo e(trans('header.drive.safety')); ?></a></li>

                                          <li><a href="<?php echo e(url('local')); ?>"><?php echo e(trans('header.drive.local_driver_guide')); ?></a></li>
                  ...
                  <div class="eats">
                     ...
                     <div class="container">
                        ...
                        <h3><?php echo e(trans('header.cabs_name')); ?></h3>
                        ...
                        <ul>
                           ...
                           <li><a href="<?php echo e(url('mylift/'.strtolower($service->name))); ?>"><?php echo e(trans('header.mylift')); ?> <?php echo e($service->name); ?></a></li>
         ...
         <div class="col-md-2 right-padding">
            ...
            <a href="<?php echo e(url('/')); ?>"><img src="<?php echo e(url(Setting::get('site_logo'))); ?>" height="100%" style="margin-top: 7%;"/></a>                    
         ...
         <div class="col-md-5 help">
            ...
            <div class="right"  style="float:right;">
               ...
               <ul class="hidden-xs">
                  ...
                  <li><a href="<?php echo e(url('/PassengerSignin')); ?>"><?php echo e(strtoupper(trans('header.li_sign_in'))); ?></a></li>

                  <?php else: ?> 

                  <li><a href="<?php echo e(url('/logout')); ?>" onclick="event.preventDefault();

                     document.getElementById('logout-form').submit();"><?php echo e(trans('header.logout')); ?></a></li>
               ...
               <a href="<?php echo e(url('/provider/register')); ?>" class="btn btn-default button-shadow" style="background-color: #000000;border-color:#000000;"><?php echo e(strtoupper(trans('header.li_became_a_driver'))); ?></a>                        
