			...
			<form id="zoneForm">
			  ...
			  <!-- Modal body --> 
				<div class="modal-body">
					...
					<div class="form-group">
						<input type="text" class="form-control" placeholder="Zone Name" name="zone_name" value="<?php echo e($zone_name); ?>" />
						<input type="hidden" name="zone_id" id="zone_id" value="<?php echo e($zone_id); ?>" />
					</div>
					<div class="form-group">
