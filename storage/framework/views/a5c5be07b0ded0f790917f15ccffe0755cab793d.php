        ...
        <div class="col-md-4">
            <form role="form" method="POST" action="<?php echo e(url('/register')); ?>">
                    <?php echo e(csrf_field()); ?>
                      ...
                      <label style="margin-top: inherit;"><?php echo e(trans('passengersignin.name')); ?></label>
                      <input id="name" type="text" class="form-control" name="first_name" value="" placeholder="<?php echo e(trans('passengersignin.name')); ?>" autofocus="">
                      ...
                      <input type="text" autofocus="" id="phone_number" class="form-control" placeholder="<?php echo e(trans('passengersignin.phone')); ?>" name="phone_number" value="">
                      ...
                      <input id="email" type="email" class="form-control" name="email" value="" placeholder="<?php echo e(trans('passengersignin.email_addr')); ?>">
                    ...
                    <div class="facebook_btn">
                        <button type="submit" value="submit" class="btn btn-default btn-arrow-left" style="background-color: #ec58d6;"><?php echo e(trans('passengersignin.next')); ?> </button>
         ...
         <div class="col-md-8">
            <img src="<?php echo e(url('asset/front_dashboard/img/User-Signup.png')); ?>" alt="User Login" style="margin-top:-47px"> 
         </div>
    </div>
    </div>
</div>
